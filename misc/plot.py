...
def plot_nfe_data_scaled():
    ...
    critical_iterative_denoising = [9251, 9917, 9978, 9991, 9998, 9996]
    iterative_denoising = [5731, 6933, 7680, 7809, 8015, 8037]
    discrete_diffusion = [3825, 7366, 9271, 9769, 9906, 9958]
    ...
    critical_iterative_denoising = [val for val in mask_cid]
    iterative_denoising = [val for val in marg_id]
    discrete_diffusion = [val for val in marg_ddm]
    ...
    plt.plot(nfe, iterative_denoising, marker='s', linewidth=3.0, markersize=8.0,
             label='Iterative Denoising (Marg.) - Ours',  color=colors[4])

    # Add labels and legend
    #plt.title('Validity on Zinc250k', fontsize=24)
    plt.xlabel('NFE', fontsize=18)
    plt.ylabel('NSPDK ($10^{-3}$)', fontsize=18)
    plt.xticks(nfe, fontsize=16)
